...
const Footer = () => {
  return (
    <footer className="bg-aspirvacum-dark text-white">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                ...
                className="text-white hover:text-aspirvacum-blue"
              >
          ...
          <div>
            ...
            <div className="space-y-2">
              <a
                ...
                className="block text-white hover:text-aspirvacum-blue"
              >
                +351 917 601 184
              </a>
              <a
        ...
        <div className="container mx-auto px-4 flex flex-col md:flex-row justify-between items-center text-sm">
          <div className="mb-4 md:mb-0">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-aspirvacum-blue"
            >
              gtit.pt
            </a>
          </div>
          <nav className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-6">
            <Link to="/a-empresa" className="text-white hover:text-aspirvacum-blue">
              Saiba mais sobre a Aspirvacum
            </Link>
            <Link to="/contatos" className="text-white hover:text-aspirvacum-blue">Entre em contacto connosco</Link>
            <Link to="/mapa-site" className="text-white hover:text-aspirvacum-blue">Mapa do Site</Link>
          </nav>
        </div>
      </div>
    </footer>
